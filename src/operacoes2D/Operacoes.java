...
import operacoes3d.Matriz;
import operacoes3d.Ponto;
import projetoCG.PanelPrincipal;

public class Operacoes {
	/**
	 * Matriz geradora de translacao em uma matriz de 2D (duas dimensoes).
	 * @param tx
	 * @param ty
	...
	/**
	 * Matriz geradora de escala em uma matriz de 2D (duas dimensoes).
	 * @param sx
	 * @param sy
	 * @return
	 */
	...
	/**
	 * Matriz de rotacao em uma matriz de 2D (duas dimensoes)
	 * @param angulo
